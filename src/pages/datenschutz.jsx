  ...
  return (
    ...
    >
      <div className="flex justify-center my-10 px-2">
        <div className="max-w-[1000px] min-w-[280px]">
          <h2 className="font-bold text-[#0097B2]">
          ...
          <p>
            ...
            hergestellt. Instagram erh&auml;lt dadurch Informationen &uuml;ber
          ...
          <p>
            ...
            erfolgende Verarbeitung durch Facebook bzw. Instagram ist nicht Teil
            ...
            F&uuml;r die Datensicherheit der Facebook bzw. Instagram-Produkte
